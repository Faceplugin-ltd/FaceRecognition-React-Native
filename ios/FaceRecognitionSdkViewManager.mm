...
didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer
    ...
    @autoreleasepool {
        ...
        param.check_liveness = YES;
        param.check_eye_closeness = YES;
        param.check_face_occlusion = YES;
        param.check_mouth_opened = YES;
        param.estimate_age_gender = YES;
        
        NSArray *faceBoxes = [FaceSDK faceDetection:capturedImage param:param];
